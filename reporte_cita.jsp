...
<li class="treeview">
  ...
  <form name="reporte" action="/Proyecto/ControladorCitaReporte">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
                ...
                <center>
              <h3 class="box-title"><input type="submit" name="button" class="btn btn-success" id="button" value="Reporte de Citas"> </h3></center>
