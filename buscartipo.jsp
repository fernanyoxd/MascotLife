            ...
            <div class="box-header">
              ...
              <div class="box-tools">
                <div class="input-group input-group-sm" style="width: 200px;">
                     ...
                     <input type="text" name ="txtbuscar"  class="form-control pull-right" placeholder="Ingrese Tipo Tratamiento" id="busqueda">
...
Iterator<Tipo_Tratamiento>iter=lista.iterator();
